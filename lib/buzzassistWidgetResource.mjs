...
export function buzzAssistWidgetResourceMetadata({
  ...
  description = "Render and control the project-local BuzzAssist canvas directly inside a Codex or Claude Desktop MCP Apps widget.",
} = {}) {
  return {
    title,
    description,
...
export function createBuzzAssistWidgetHtml({ version = "0.1.5" } = {}) {
...
function createBuzzAssistWidgetLauncherHtml({ version = "0.1.5" } = {}) {
  return `<!doctype html>
<html lang="ja">
<head>
  <meta charset="utf-8" />
    ...
    <main>
      ...
      <aside class="panel side">
        ...
        <div class="notice" id="messageText">
          Codexではnative widget bridge、Claude DesktopではMCP Apps bridgeを使います。Claude Codeはwidgetを描画しないため、この入口ではなくMCP toolsで読みます。
        </div>
...
function createBuzzAssistStaticCanvasWidgetHtml({ version = "0.1.5" } = {}) {
