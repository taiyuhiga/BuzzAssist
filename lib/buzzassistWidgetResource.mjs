...
export function createBuzzAssistWidgetHtml({ version = "0.1.7" } = {}) {
...
function createBuzzAssistWidgetLauncherHtml({ version = "0.1.7" } = {}) {
  return `<!doctype html>
<html lang="ja">
<head>
  <meta charset="utf-8" />
...
function createBuzzAssistStaticCanvasWidgetHtml({ version = "0.1.7" } = {}) {
