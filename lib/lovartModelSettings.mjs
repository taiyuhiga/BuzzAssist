...
export const LOVART_IMAGE_MODEL_SETTINGS = {
  ...
  // Midjourney is Lovart-only (no fal.ai endpoint). Lovart's own web UI
  // exposes the model version (v8.1/v7/niji/niji7) and a 高精細レンダリング
  // toggle, so we mirror those and deliver them as prompt hints.
  "lovart-midjourney": {
    aspects: ["16:9", "4:3", "1:1", "3:4", "9:16", "2:3", "3:2"],
    versions: ["v8.1", "v7", "niji", "niji7"],
