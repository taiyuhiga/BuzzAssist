...
export const MEDIA_ROUTES = [
  ...
  { id: "runway", label: "Runway", icon: "runway", note: "APIキー" },
  { id: "higgsfield", label: "Higgsfield", icon: "higgsfield", note: "クレジット" },
];

// Route priority for a family's default: free/local first.
export const ROUTE_PRIORITY = ["codex", "hermes", "buzzassist", "lovart", "runway", "higgsfield"];
...
export const IMAGE_MODEL_FAMILIES = [
  ...
  // (see qualityVariants) instead of appearing as extra catalog entries.
  {
    ...
    label: "GPT Image 2",
    provider: "openai",
    routes: { codex: "gpt-image-2-codex", buzzassist: "gpt-image-2", lovart: "lovart-gpt-image-2", higgsfield: "higgsfield-gpt-image-2" },
    qualityVariants: {
      lovart: {
  ...
  { id: "nano-banana-2", label: "Nano Banana 2", provider: "nano-banana", routes: { buzzassist: "nano-banana-2", lovart: "lovart-nano-banana-2", higgsfield: "higgsfield-nano-banana-2" } },
  ...
  { id: "runway-gen4-image", label: "Runway Gen-4 Image", provider: "runway", routes: { runway: "runway-gen4-image" } },
  { id: "soul-2", label: "Soul 2.0", provider: "higgsfield", routes: { higgsfield: "higgsfield-soul-2" } },
  { id: "recraft-4-1", label: "Recraft 4.1", provider: "recraft", routes: { higgsfield: "higgsfield-recraft-4-1" } },
  { id: "flux-2", label: "Flux.2", provider: "flux", routes: { higgsfield: "higgsfield-flux-2" } },
];
...
export const VIDEO_MODEL_FAMILIES = [
  ...
  { id: "seedance-2", label: "Seedance 2.0", provider: "seedance", routes: { buzzassist: "seedance-2", lovart: "lovart-seedance-2", higgsfield: "higgsfield-seedance-2" } },
  ...
  { id: "kling-3", label: "Kling 3.0", provider: "kling", routes: { buzzassist: "kling-v3", lovart: "lovart-kling-v3", higgsfield: "higgsfield-kling-3" } },
  ...
  { id: "veo-3-1", label: "Veo 3.1", provider: "veo", routes: { lovart: "lovart-veo-3-1", higgsfield: "higgsfield-veo-3-1" } },
  ...
  { id: "runway-gen4-5", label: "Runway Gen-4.5", provider: "runway", routes: { runway: "runway-gen4-5" } },
];
