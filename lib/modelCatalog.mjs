...
export const IMAGE_MODEL_FAMILIES = [
  { id: "gpt-image-2", label: "GPT Image 2", provider: "openai", routes: { codex: "gpt-image-2-codex", buzzassist: "gpt-image-2", lovart: "lovart-gpt-image-2" } },
  ...
  { id: "gpt-image-2-low", label: "GPT Image 2 Low", provider: "openai", routes: { lovart: "lovart-gpt-image-2-low" } },
  { id: "gpt-image-2-medium", label: "GPT Image 2 Medium", provider: "openai", routes: { lovart: "lovart-gpt-image-2-medium" } },
  { id: "gpt-image-2-high", label: "GPT Image 2 High", provider: "openai", routes: { lovart: "lovart-gpt-image-2-high" } },
...
function findFamily(families, modelId) {
  ...
  return families.find((family) => Object.values(family.routes).includes(modelId)) ?? null;
}
